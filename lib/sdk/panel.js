...
const Panel = Class({
  ...
  setup: function setup(options) {
    ...
    if (model.title) {
      view.setAttribute("titlebar", "normal");
      view.setAttribute("noautohide", "true");
      view.setAttribute("close", "true");
      let tb = view.ownerDocument.createElement('titlebar');
      let l = view.ownerDocument.createElement('label');
      l.label = model.title;
      tb.appendChild(l);
