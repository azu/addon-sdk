...
function URL(url, base) {
  ...
  this.__defineSetter__("protocol", function(s) {
    uri.scheme = s;
  });
  ...
  this.__defineSetter__("auth", function(s) {
    try {
      uri.userPass = s;
    } catch (e if e.result == Cr.NS_ERROR_FAILURE) {} 
  });

  this.__defineGetter__("userPass", function() {
      var userPass = null;
      try {
        userPass = uri.userPass ? uri.userPass : null;
      } catch (e if e.result == Cr.NS_ERROR_FAILURE) {}
  ...
  this.__defineSetter__("hostname", function(s) {
    try {
      uri.host = s;
    } catch (e if e.result == Cr.NS_ERROR_FAILURE) {} 
  });
  ...
  this.__defineSetter__("port",  function(s) {
    try {
      uri.port = s;
    } catch (e if e.result == Cr.NS_ERROR_FAILURE) {} 
  });
  ...
  this.__defineSetter__("path", function(s) {
    uri.path = s;
  });

  this.__defineGetter__("prePath", function() uri.prePath);
