...
exports.testParseHttp = function(test) {
  ...
  test.assertEqual(info.hostname, "foo.com");
...
exports.testStringInterface = function(test) {
  ...
  test.assertEqual(Object.keys(a), "protocol,scheme,auth,userPass,hostname,host,port,path,prePath", "enumerable key list check for URL.");

  test.assertEqual(
      JSON.stringify(a),
      "{\"protocol\":\"about\",\"scheme\":\"about\",\"auth\":null,\"userPass\":null,\"hostname\":null,\"host\":null,\"port\":null,\"path\":\"addons\",\"prePath\":\"about:\"}",
